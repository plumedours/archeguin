...
const variants = {
  primary: "bg-[#18372b] text-white shadow-lg shadow-[#18372b]/20 hover:bg-[#24513f]",
  accent: "bg-[#a56a43] text-white shadow-lg shadow-[#a56a43]/20 hover:bg-[#8d5636]",
  light: "bg-white text-[#18372b] shadow-md shadow-black/5 hover:bg-[#f6f4ee]",
  ghost: "border border-[#18372b]/15 bg-white/65 text-[#18372b] hover:border-[#18372b]/35 hover:bg-white",
};
